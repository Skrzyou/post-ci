    ...
    <section className="border-b border-border px-6 py-24">
      <Reveal>
        <div className="mx-auto flex max-w-[1100px] items-start gap-5">
          <svg viewBox="0 0 48 48" className="size-8 shrink-0 text-accent-text" role="img" aria-label="Ikona kłódki - poufność">
          ...
          <div>
            <p className="font-mono text-sm text-accent-text">Poufność</p>
