      ...
      <div className="mx-auto max-w-[1100px]">
        <Reveal>
          ...
          <p className="mt-6 max-w-[64ch] text-pretty text-lg text-muted-foreground">
            Dopiero potem szukamy rozwiązań. Na końcu właściciel wybiera jedno działanie do sprawdzenia w
            ciągu 30 dni. Cały format opiera się na jednej zasadzie: najpierw pytania, potem hipotezy.
          </p>
        </Reveal>
      </div>
    </section>
