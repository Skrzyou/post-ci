  ...
  return (
    <section className="border-b border-border bg-surface px-6 py-28">
      <div className="mx-auto max-w-[1100px]">
        <Reveal>
          <p className="font-mono text-sm text-accent-text">AKTA POST-CI</p>
        ...
        <Reveal delay={0.1}>
          <div className="mt-10 bg-background p-8 md:p-10">
            ...
            <div className="mt-6 grid grid-cols-1 gap-6 md:grid-cols-2">
              <div>
                <p className="font-mono text-xs text-accent-text">Z CZYM PRZYSZEDŁ</p>
              ...
              <div>
                <p className="font-mono text-xs text-accent-text">CO WYGLĄDAŁO NA PRZYCZYNĘ</p>
                <p className="mt-2 text-pretty text-muted-foreground">
              ...
              <div>
                <p className="font-mono text-xs text-accent-text">CO ZNALEŹLIŚMY GŁĘBIEJ</p>
                <p className="mt-2 text-pretty text-muted-foreground">
              ...
              <div>
                <p className="font-mono text-xs text-accent-text">RUCH NA 30 DNI</p>
                <p className="mt-2 text-pretty text-muted-foreground">
            ...
            <div className="mt-6 border-t border-border pt-6">
              <p className="font-mono text-xs text-accent-text">MIESIĄC PÓŹNIEJ</p>
